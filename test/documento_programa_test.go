...
func run_bee() {
	...
	parametros := "DOCUMENTO_PROGRAMA_HTTP_PORT=" + beego.AppConfig.String("httpport") + " DOCUMENTO_PROGRAMA_CRUD__PGUSER=" + beego.AppConfig.String("PGuser") + " DOCUMENTO_PROGRAMA_CRUD__PGPASS=" + beego.AppConfig.String("PGpass") + " DOCUMENTO_PROGRAMA_CRUD__PGURLS=" + beego.AppConfig.String("PGurls") + " DOCUMENTO_PROGRAMA_CRUD__PGDB=" + beego.AppConfig.String("PGdb") + " DOCUMENTO_PROGRAMA_CRUD__SCHEMA=" + beego.AppConfig.String("PGschemas") + " bee run"
...
func iSendRequestToWhereBodyIsJson(method, endpoint, bodyreq string) error {
	...
	if method == "POST" && resStatus == "201 Created" {
		...
		resDuplex = resDuplex + "\t\t\"Severity\": \"ERROR\",\r\n\t\t\"Code\": \"23505\",\r\n\t\t\"Message\": \"llave duplicada viola restricción de unicidad «pk_tipo_documento_programa»\",\r\n"
		resDuplex = resDuplex + "\t\t\"Detail\": \"Ya existe la llave (id)=(" + strconv.Itoa(int(Id)) + ").\",\r\n\t\t\"Hint\": \"\",\r\n\t\t\"Position\": \"\",\r\n\t\t\"InternalPosition\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"InternalQuery\": \"\",\r\n\t\t\"Where\": \"\",\r\n\t\t\"Schema\": \"documentos_programas\",\r\n\t\t\"Table\": \"tipo_documento_programa\",\r\n\t\t\"Column\": \"\",\r\n"
		resDuplex = resDuplex + "\t\t\"DataTypeName\": \"\",\r\n\t\t\"Constraint\": \"pk_tipo_documento_programa\",\r\n\t\t\"File\": \"nbtinsert.c\",\r\n\t\t\"Line\": \"434\",\r\n\t\t\"Routine\": \"_bt_check_unique\"\r\n\t}\r\n}"

		ioutil.WriteFile("./files/res3/Ierr10.json", []byte(resDuplex), 0644)
	}
	return nil
